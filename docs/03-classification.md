...
<p class="caption">(\#fig:ex13h)Confusion matrix for the logistic model on the test set.</p>
</div>
</center>
...
<p class="caption">(\#fig:ex13j)Evolution of percentage of incorrect predictions compared to $K$.</p>
</div>
