...
{\centering \includegraphics{04-resampling_files/figure-latex/ex2g-1} 

}

\caption{Probability that a particular observation belongs to the bootstrap sample.}(\#fig:ex2g)
\end{figure}
</center>
...
This piece of code repeatedly create bootstrap samples, and each time we record whether or not the fourth observation is contained in the bootstrap sample. In mean, we found that the fourth observation is contain in 64.4% of the samples. So, we retrieve the observation that gave at the previous question.
...
The estimation of the coefficient for the `ìncome` feature is $\ensuremath{2.0808976\times 10^{-5}}$ with a standard error of $\ensuremath{4.9851672\times 10^{-6}}$. And the estimation of the coefficient for the `balance` feature is $0.0056471$ with a standard error of $\ensuremath{2.2737314\times 10^{-4}}$.
...
Using the bootstrap method, the estimation of the coefficient for the `income` feature is $\ensuremath{2.0808976\times 10^{-5}}$ with a standard error of $\ensuremath{5.0734443\times 10^{-6}}$. And the estimation of the coefficient for the `balance` feature is $0.0056471$ with a standard error of $\ensuremath{2.2991334\times 10^{-4}}$.
...
\begin{center}\includegraphics{04-resampling_files/figure-latex/ex8b-1} \end{center}
</center>
