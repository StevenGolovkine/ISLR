...
{\centering \includegraphics{02-regression_files/figure-latex/ex15ci-1} 

}

\caption{Plot of the coefficients from the univariate models against the multivariate model.}(\#fig:ex15ci)
\end{figure}
